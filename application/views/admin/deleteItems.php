...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>NewFangeld Saree Store</title>
                ...
                <div class="container">
                    <nav>
                        <ul id="menu-top-bar-left" class="nav nav-inline pull-left animate-dropdown flip">
                            <li class="menu-item animate-dropdown"><a title="Welcome to Saree  Store" href="#">Welcome to Admin Page</a></li>
                        </ul>
                    </nav>
...
<!--                    <nav>
                            ...
                            <div class="collapse navbar-toggleable-xs" id="default-header">
                                <nav>
                                    <ul id="menu-main-menu" class="nav nav-inline yamm">
                                        ...
                                        <li class="menu-item animate-dropdown"><a title="About Us" href="<?php echo base_url();?>admin/notify/notifications.php">Notifications</a></li>

                                 <li class="menu-item"><a title="Features" href="<?php echo base_url();?>admin/add/addItems.php">Add Items</a></li>
                                        <li class="menu-item"><a title="Contact Us" href="<?php echo base_url();?>admin/update/updateItems.php">Update Items</a></li>
                                         <li class="menu-item"><a title="Contact Us" href="<?php echo base_url();?>admin/delete/deleteItems.php">Delete Items</a></li>
                                         <!--<li class="menu-item"><a title="Contact Us" href="<?php echo base_url();?>admin/logout/logout.php">Logout</a></li>-->
                                    </ul>
                                </nav>  
                            </div>
                        </div>
            ...
            <div id="content" class="site-content" tabindex="-1">
                <div class="container">
                    ...
                    <nav class="woocommerce-breadcrumb" ><a href="home.php">Admin</a><span class="delimiter"><i class="fa fa-angle-right"></i></span> Account</nav><!-- .woocommerce-breadcrumb -->
...
<!--                                                <div class="col-2">
                                                    ...
                                                    <form method="post" class="register">
                                                        ...
                                                        <p class="form-row form-row-wide">
                                                            ...
                                                            <input type="text" class="input-text" name="user" id="reg_user" value="" />
                                                        </p>
                                                        <p class="form-row form-row-wide">
                                                        ...
                                                        <p class="form-row form-row-wide">
                                                            ...
                                                            <input type="text" class="input-text" name="pwd" id="reg_pwd" value="" />
                                                        </p>
                                                        <p class="form-row form-row-wide">
                                                            <label for="reg_email">Conform Password<span class="required">*</span></label>
                                                            <input type="text" class="input-text" name="cpwd" id="reg_cpwd" value="" />
                                                        </p>
            ...
            <footer id="colophon" class="site-footer">
            	...
            	<div class="copyright-bar">
            		<div class="container">
            			<div class="pull-left flip copyright">&copy; <a href="http://demo2.transvelo.in/html/electro/">NFSS</a> - All Rights Reserved</div>
