...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Welcome to Newfangled Sarees Store</title>
                    ...
                    <nav class="woocommerce-breadcrumb" ><a href="home.php">Admin</a><span class="delimiter"><i class="fa fa-angle-right"></i></span> Account</nav>
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <form method="post" class="register">
                                                        ...
                                                        <p class="form-row form-row-wide">
                                                            <label for="reg_email">Cost Per Item<span class="required">*</span></label>
                                                            <input type="text" class="input-text" name="cpwd" id="reg_cpwd" value="" />
                                                        </p>
                                                         <p class="form-row form-row-wide">
                                                            <label for="reg_email">Images<span class="required">*</span></label>
                                                            <input type="text" class="input-text" name="cpwd" id="reg_cpwd" value="" />
                                                        </p>
                                                         <p class="form-row form-row-wide">
                                                            <label for="reg_email">Description<span class="required">*</span></label>
                                                         
                                                           <textarea  rows="4" cols="50" class="input-text" name="cpwd" id="reg_cpwd" value=""></textarea>
                                                        </p>
                                                      
                                                           <input type="submit" class="button" name="up" value="Update" />
                                                           <input type="submit" class="button" name="del" value="Delete" />
                                                           
                                                     <input type="submit" class="button" name="can" value="Cancle" />
