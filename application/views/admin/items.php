  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form data-toggle="validator" action="<?php echo base_url()?>items/store" onclick="manageData()" method="POST">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form data-toggle="validator" action="<?php echo base_url()?>items_controller/edit" method="put">
