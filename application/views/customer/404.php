            	...
            	<div class="container">
                    ...
                    <nav>
                        <ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
                            ...
                            <li class="menu-item animate-dropdown"><a title="Track Your Order" href="<?php echo base_url();?>navbar/trakOrder/track-your-order.php"><i class="ec ec-transport"></i>Track Your Order</a></li>
                            <li class="menu-item animate-dropdown"><a title="Shop" href="<?php echo base_url();?>navbar/shop/shop.php"><i class="ec ec-shopping-bag"></i>Shop</a></li>
                            <li class="menu-item animate-dropdown"><a title="My Account" href="<?php echo base_url();?>navbar/my_account/my-account.php"><i class="ec ec-user"></i>My Account</a></li>
                        </ul>
                    </nav>
                            ...
                            <div class="collapse navbar-toggleable-xs" id="default-header">
                                <nav>
                                    <ul id="menu-main-menu" class="nav nav-inline yamm">
                                        <li class="menu-item menu-item-has-children animate-dropdown dropdown"><a title="Home" href="<?php echo base_url();?>navbar/shop/shop.php"  aria-haspopup="true">Home</a>
<!--                                            <ul role="menu" class=" dropdown-menu">
                                        ...
                                        <li class="menu-item animate-dropdown"><a title="About Us" href="<?php echo base_url();?>navbar/about/about.php">About Us</a></li>

                                        <li class="menu-item"><a title="Features" href="#">Features</a></li>
                                        <li class="menu-item"><a title="Contact Us" href="<?php echo base_url();?>navbar/contact/contact.php">Contact Us</a></li>
                                    </ul>
                                </nav>                              </div>
                        </div>
                    ...
                    <ul class="nav navbar-nav departments-menu animate-dropdown">
                        <li class="nav-item dropdown ">
                            ...
                            <ul id="menu-vertical-menu" class="dropdown-menu yamm departments-menu-dropdown">
                                <li class="highlight menu-item animate-dropdown active"><a title="Value of the Day" href="product-category.php">Value of the Day</a></li>
                                <li class="highlight menu-item animate-dropdown"><a title="Top 100 Offers" href="home-v3.php">Top 100 Offers</a></li>
                                <li class="highlight menu-item animate-dropdown"><a title="New Arrivals" href="home-v3-full-color-background.php">New Arrivals</a></li>

                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2584 dropdown">
                                    <a title="Computers &amp; Accessories" href="product-category.php" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Computers &#038; Accessories</a>
                                    <ul role="menu" class=" dropdown-menu">
                                ...
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2585 dropdown">
                                    <a title="Cameras, Audio &amp; Video" href="product-category.php" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Cameras, Audio &#038; Video</a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li class="menu-item animate-dropdown menu-item-object-static_block">
                                            <div class="yamm-content">
                                                <div class="vc_row row wpb_row vc_row-fluid bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                ...
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2586 dropdown">
                                    <a title="Mobiles &amp; Tablets" href="product-category.php" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Mobiles &#038; Tablets</a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li class="menu-item animate-dropdown menu-item-object-static_block">
                                            <div class="yamm-content">
                                                <div class="vc_row row wpb_row vc_row-fluid bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                ...
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2587 dropdown">
                                    <a title="Movies, Music &amp; Video Games" href="product-category.php" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Movies, Music &#038; Video Games</a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li class="menu-item animate-dropdown menu-item-object-static_block">
                                            <div class="yamm-content">
                                                <div class="vc_row row wpb_row vc_row-fluid bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                ...
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2588 dropdown">
                                    <a title="TV &amp; Audio" href="product-category.php" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">TV &#038; Audio</a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li class="menu-item animate-dropdown menu-item-object-static_block">
                                            <div class="yamm-content">
                                                <div class="vc_row row wpb_row vc_row-fluid bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                ...
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2589 dropdown">
                                    ...
                                    <a title="Watches &amp; Eyewear" href="product-category.php" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Watches &#038; Eyewear</a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li class="menu-item animate-dropdown menu-item-object-static_block">
                                            <div class="yamm-content">
                                                <div class="vc_row row wpb_row vc_row-fluid bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                ...
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2590 dropdown">
                                    ...
                                    <a title="Car, Motorbike &amp; Industrial" href="product-category.php" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Car, Motorbike &#038; Industrial</a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li class="menu-item animate-dropdown menu-item-object-static_block">
                                            <div class="yamm-content">
                                                <div class="vc_row row wpb_row vc_row-fluid bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                ...
                                <li class="menu-item animate-dropdown"><a title="Accessories" href="product-category.php">Accessories</a></li>
                                <li class="menu-item animate-dropdown"><a title="Printers &amp; Ink" href="product-category.php">Printers &#038; Ink</a></li>
                                <li class="menu-item animate-dropdown"><a title="Software" href="product-category.php">Software</a></li>
                                <li class="menu-item animate-dropdown"><a title="Office Supplies" href="product-category.php">Office Supplies</a></li>
                                <li class="menu-item animate-dropdown"><a title="Computer Components" href="product-category.php">Computer Components</a></li>
                                <li class="menu-item animate-dropdown"><a title="Car Electronic &amp; GPS" href="product-category.php">Car Electronic &#038; GPS</a></li>
                                <li class="menu-item animate-dropdown"><a title="Accessories" href="product-category.php">Accessories</a></li>
                                <li class="menu-item animate-dropdown"><a title="Printers &amp; Ink" href="product-category.php">Printers &#038; Ink</a></li>
                            </ul>
                        </li>
...
<!--                    <ul class="navbar-compare nav navbar-nav pull-right flip">
                    	<li class="nav-item">
                    		<a href="compare.php" class="nav-link"><i class="ec ec-compare"></i></a>
                    	</li>
                    </ul>-->
                </div>
            </nav>
            ...
            <div id="content" class="site-content" tabindex="-1">
            	<div class="container">
                	...
                	<nav class="woocommerce-breadcrumb"><a href="home.php">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>Error 404</nav>
            					...
            					<aside class="widget clearfix">
            						<div class="body">
            							...
            							<ul class="product_list_widget">
            								<li>
            									<a href="single-product.php" title="Tablet Thin EliteBook  Revolve 810 G6">
            								...
            								<li>
            									<a href="single-product.php" title="Smartphone 6S 128GB LTE">
            								...
            								<li>
            									<a href="single-product.php" title="Smartphone 6S 64GB LTE">
            					...
            					<aside class="widget clearfix">
            						<div class="body"><h4 class="widget-title">Onsale Products</h4>
            							<ul class="product_list_widget">
            								...
            								<li>
            									<a href="single-product.php" title="Tablet Red EliteBook  Revolve 810 G2">
            								...
            								<li>
            									<a href="single-product.php" title="Widescreen 4K SUHD TV">
            							...
            							<div class="body">
            								...
            								<div class="menu-footer-menu-1-container">
            									<ul id="menu-footer-menu-1" class="menu">
            										<li class="menu-item"><a href="single-product.php">Laptops &#038; Computers</a></li>
            										<li class="menu-item"><a href="single-product.php">Cameras &#038; Photography</a></li>
            										<li class="menu-item"><a href="single-product.php">Smart Phones &#038; Tablets</a></li>
            										<li class="menu-item"><a href="single-product.php">Video Games &#038; Consoles</a></li>
            										<li class="menu-item"><a href="single-product.php">TV &#038; Audio</a></li>
            										<li class="menu-item"><a href="single-product.php">Gadgets</a></li>
            										<li class="menu-item "><a href="single-product.php">Car Electronic &#038; GPS</a></li>
            									</ul>
            								</div>
            							</div>
            						</aside>
            							...
            							<div class="body">
            								...
            								<div class="menu-footer-menu-2-container">
            									<ul id="menu-footer-menu-2" class="menu">
            										<li class="menu-item"><a href="single-product.php">Printers &#038; Ink</a></li>
            										<li class="menu-item "><a href="single-product.php">Software</a></li>
            										<li  class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-2742"><a href="single-product.php">Office Supplies</a></li>
            										<li  class="menu-item "><a href="single-product.php">Computer Components</a></li>
            									</ul>
            								</div>
            							</div>
            						</aside>
            							...
            							<div class="body">
            								...
            								<div class="menu-footer-menu-3-container">
            									<ul id="menu-footer-menu-3" class="menu">
            										<li class="menu-item"><a href="single-product.php">My Account</a></li>
            										<li class="menu-item"><a href="single-product.php">Track your Order</a></li>
            										<li class="menu-item"><a href="single-product.php">Wishlist</a></li>
            										<li class="menu-item"><a href="single-product.php">Customer Service</a></li>
            										<li class="menu-item"><a href="single-product.php">Returns/Exchange</a></li>
            										<li class="menu-item"><a href="single-product.php">FAQs</a></li>
            										<li class="menu-item"><a href="hsingle-product.php">Product Support</a></li>
            									</ul>
            								</div>
            							</div>
            						</aside>
