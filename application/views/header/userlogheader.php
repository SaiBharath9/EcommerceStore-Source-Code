                ...
                <div class="container">
                    ...
                    <nav>
                        <ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
                            ...
                            <li class="menu-item menu-item-has-children animate-dropdown dropdown"><a title="My Account"  data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">My account</a>
                ...
                <div class="container">
                    <ul class="nav navbar-nav departments-menu animate-dropdown">
                        <li class="nav-item dropdown ">
                            ...
                            <a class="nav-link" href="#" id="departments-menu-toggle" >Shop by Department</a>
