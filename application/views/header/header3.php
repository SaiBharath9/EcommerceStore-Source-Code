                    ...
                    <nav>
                        ...
                        <li class="menu-item menu-item-has-children animate-dropdown dropdown"style="margin-right:100px"><a title="My Account"  data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">My account</a>
                         <ul role="menu" class=" dropdown-menu">                 
                                                ...
                                                <li class="menu-item animate-dropdown  "><a title="profile" href="home.html"> profile</a></li>
                ...
                <div class="container">
                    <div class="row">
                      ...
                      <div class="header-logo">
                            <a href="Welcome" class="header-logo-link">
                            ...
                            <div class="collapse navbar-toggleable-xs" id="default-header" style="margin-top: 40px;margin-left: 35px">
                                <nav>
                                    <ul id="menu-main-menu" class="nav nav-inline yamm">
                                        <li class="menu-item menu-item-has-children "><a title="Home" href="<?php echo base_url(); ?>Welcome" aria-haspopup="true">Home</a>
                    ...
                    <ul class="nav navbar-nav departments-menu animate-dropdown">
                        <li class="nav-item dropdown ">
                            ...
                            <ul id="menu-vertical-menu" class="dropdown-menu yamm departments-menu-dropdown">
                                ...
                                <!--<li class="highlight menu-item animate-dropdown"><a title="New Arrivals" href="<?php echo base_url();?>category_Of_Sarees/uppada">Chiffon</a></li>-->
                                 <li class="highlight menu-item animate-dropdown"><a title="New Arrivals" href="<?php echo base_url();?>category_Of_Sarees/pattu">Banaras</a></li>
